var store = [{
        ...
        "excerpt":"Building user journeys as declarative trees within a virtual assistant requires assumptions to be made about the user query and the optimal path. This is excessbated if there are many decision points and tree consists of many forks as assumptions about the path increase exponentially as the journey progresses further...","categories": ["generativeAI","conversationalAI"],
